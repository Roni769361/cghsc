                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-6 col-md-6 text-end">
                                                        <h5>
                                                            @if($result->status == 1)
                                                            <span class="badge bg-success"> আপনার পেমেন্ট যাচাই করা হয়েছে
                                                                @else
                                                                <span class="badge bg-danger"> আপনার পেমেন্ট যাচাই করা হয়নি, <br> দয়া করা আপনার ব্যাচ প্রতিনিদির সাথে যোগাযোগ করুন।
                                                                </span>
                                                                @endif
                                                        </h5>
                                                    ...
                                                    <div class="col-6 col-md-6 text-left">
                                                        <h5> <span class="badge bg-info">TrxID is: SXDA101ADA</span>
                                                        </h5>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row border-1">
                                                    ...
                                                    <div class="col-10 col-md-10">
                                                        <table class="table table-hover">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <td style="font-size: 20px;">{{$result->name}}</td>
                                                                </tr>
                                                                <tr>

                                                                    <td><i style="color: #198754; font-size: 30px;" class="fa-solid fa-phone"></i>
                                                                    </td>
                                                                    <td style="font-size: 20px;">{{$result->phone}}</td>
                                                                </tr>
                                                                <tr>

                                                                    <td><i style="color: #198754; font-size: 30px;" class="fa-solid fa-school"></i></td>
                                                                    <td style="font-size: 20px;">{{$result->batch_no}}
                                                                    </td>
                                                                </tr>
                                                                <tr>

                                                                    <td><i style="color: #198754; font-size: 30px;" class="fa-solid fa-people-group"></i></td>
                                                                    <td style="font-size: 20px;">
                                                                        @if($result->guest == "")
                                                                        আপনার সাথে কোন অতিথি নাই
                                                                        @else
                                                                        {{$result->guest}}
                                                                        @endif
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><i style="color: #198754; font-size: 30px;" class="fa-solid fa-shirt"></i></td>
                                                                    <td style="font-size: 20px;">{{$result->shirt}}</td>
                                                                </tr>
                                                                <tr>

                                                                    <td><i style="color: red; font-size: 30px;" class="fa-solid fa-droplet"></i></td>
                                                                    <td style="font-size: 20px;">
                                                                        {{$result->blood_group}}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td><i style="color: #198754; font-size: 30px;" class="fa-solid fa-location-dot"></i></td>
                                                                    <td style="font-size: 20px;">{{$result->add}}</td>
                                                                </tr>
                                                                <tr>

                                                                    <td><i style="color: #198754; font-size: 30px;" class="fa-solid fa-check"></i></td>
                                                                    <td style="font-weight: 800; font-size: 20px">
                                                                        বিজ্ঞপ্তি: আপনার আইডি
                                                                        কার্ড আপনার ব্যাচ প্রতিনিধির নিকট হতে বুঝে নিন।
                                                                        ধন্যবাদ।</td>
                                                                </tr>
                                                            </thead>
                                                        ...
                                                        <a href="{{ url('/web/search/pdf', $result->slug) }}" class="btn btn-primary shadow">সংরক্ষণ করুন</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
