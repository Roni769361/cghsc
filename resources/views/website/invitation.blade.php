                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-12 mx-auto text-center">
                                                <br>
                                                <h3>আপনার নিমন্ত্রণপত্র ডাউনলোড করুন</h3>
                                                <div class="row">
                                                    <div class="col-md-8 mx-auto">
                                                        <form action="{{ route('search') }}" method="GET">
                                                            <div>

                                                                <input type="text" name="trxID" placeholder="আপনার বিকাশ থেকে আসা ট্রানজেকশন আইডি দিন" class="form-control text-center" style="display: inline-block;">
                                                                <br><br>
                                                                <button type="submit" class="btn btn-success shadow text-center" style="display: inline-block;">Search</button>
                                                            </div>
